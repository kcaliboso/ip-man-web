<template>
  <aside
    :class="
      cn(
        'z-40 flex h-full flex-col bg-white transition-all duration-200 dark:bg-slate-950 border-r border-slate-200',
  ...
  >
    <div class="flex h-12 items-center justify-between px-3">
      <span v-if="open" class="font-semibold">IPman</span>
      <span v-else class="hidden font-semibold lg:block">IP</span>
